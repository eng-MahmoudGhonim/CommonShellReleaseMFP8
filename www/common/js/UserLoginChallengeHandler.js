...
var UserLoginChallengeHandler = function() {
	...
	console.log("UserLoginChallengeHandler initialized ");
    ...
    userLoginChallengeHandler.handleSuccess = function(data) {
        ...
        //showProtectedDiv();
        console.log("login successfully Done hello" +  data.user.displayName);

    };

    userLoginChallengeHandler.handleFailure = function(error) {
		console.log("handleChallenge handleFailure");
     ...
     userLoginChallengeHandler.login=function(username,password,rememberMeState) {
    ...
    userLoginChallengeHandler.logout=function() {

...
/* JavaScript content from js/com/views/shell/SplashScreenTolerance.js in folder common */
...
var SplashModel = {
		...
		getSplashScreen:function(callback){
			...
			rawFile.open("GET", baseUrl+"/common/pages/shell/splash_screen_tolerance.html", true);
...
//						= 'translate3d('+transformVal+'px, 0px, 0px)';
						...
						//this only for show splash screen  in webview
						//1- change to be  isWeb = false;  in main.js
						//2- uncoments the below function
						/*setTimeout(function () {
